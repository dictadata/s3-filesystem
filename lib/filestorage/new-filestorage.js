/**
 * storage-junctions/new-filestorage.js
 * 
 * This class is a copy of the fs-filestorage class from the storage-junctions library.
 * 
 */
"use strict";
...
module.exports = exports = class newFileStorage extends FileStorage {
  ...
  */
  async createReadStream() {
    logger.debug("newFileStorage createReadStream");
  ...
  */
  async createWriteStream() {
    logger.debug("newFileStorage createWriteStream");
    let options = this.options || {};
    let ws = false;
